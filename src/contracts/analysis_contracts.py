...
class RawAnalyticalDossier(BaseModel):
    ...
    steel_manned_perspectives: List[Dict[str, str]]
    key_tensions: List[Dict[str, str]]
    synergistic_insights: List[Dict[str, str]]
    decision_framework: Dict[str, List[Dict[str, str]]]
