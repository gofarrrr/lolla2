"""
FastAPI routes for METIS Engagement API
"""
...
# FastAPI app
app = FastAPI(
    title="METIS Cognitive Intelligence API",
    description="The world's first AI-native Consultant's Operating System",
    version="7.0.0",
    docs_url="/api/docs",
    redoc_url="/api/redoc",
)
...
@app.post(
    "/api/v1/engagements", response_model=EngagementResponse, tags=["Engagements"]
)
...
@app.get(
    "/api/v1/engagements", response_model=List[EngagementResponse], tags=["Engagements"]
)
...
@app.get(
    "/api/v1/users/{user_id}/engagements",
...
@app.post(
    "/api/v1/engagements/{engagement_id}/phases/{phase}/execute",
...
@app.get(
    "/api/v1/engagements/{engagement_id}/phases/{phase}",
    response_model=PhaseResult,
    tags=["Execution"],
)
...
@app.post("/api/v1/engagements/{engagement_id}/deliverable", tags=["Deliverables"])
...
@app.post("/api/v1/engagements/{engagement_id}/what-if", tags=["What-If Analysis"])
...
@app.post("/api/v2/engagements/compare", tags=["Engagement Comparison"])
...
@app.get("/api/v2/engagements/{engagement_id}/cost-estimate", tags=["Cost Estimation"])
...
@app.get("/api/v2/engagements/{engagement_id}/rerun-status", tags=["Re-run Limits"])
...
@app.post("/api/v2/engagements/{temp_id}/promote", tags=["Scenario Promotion"])
...
@app.get("/api/v2/engagements/promoted-scenarios", tags=["Scenario Promotion"])
...
@app.get("/api/v2/engagements/{engagement_id}/scenarios", tags=["Scenario Promotion"])
...
@app.get("/api/v1/clarification/{session_id}/status", tags=["HITL Clarification"])
...
@app.post(
    "/api/v1/clarification/{session_id}/create-engagement",
    response_model=EngagementResponse,
    tags=["HITL Clarification"],
)
...
@app.post(
    "/api/v2/clarification/{session_id}/continue",
...
@app.post(
    "/api/v2/engagements/create_from_clarification",
...
# WebSocket endpoints
@app.websocket("/api/v1/engagements/{engagement_id}/ws")
...
@app.get("/api/v1/engagements/{engagement_id}/transparency", tags=["Transparency"])
